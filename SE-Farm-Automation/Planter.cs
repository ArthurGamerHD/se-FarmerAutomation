...
namespace FarmerAutomation
{
    ...
    public class Planter : MyGameLogicComponent
    {
        ...
        static Color _debugReadColor = new Color(0, 255, 0, 128);
        static Color _debugSleepColor = new Color(255, 0, 0, 128);
        ...
        IMyResourceStorageComponent _resourceStorage;
        ...
        public override void Init(MyObjectBuilder_EntityBase objectBuilder)
        {
            ...
            {
                var planterComponent = component as IMyFarmPlotLogic;
                var storageComponent = component as IMyResourceStorageComponent;
                
                if(planterComponent!=null && _planterComponent == null)
                    _planterComponent = planterComponent;

                if(storageComponent!=null && _resourceStorage == null)
                    _resourceStorage = storageComponent;
                
                if (_planterComponent != null && _resourceStorage != null)
                    break;
            }
